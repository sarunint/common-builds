...
var HttpUrlEncodingCodec = /** @class */ (function () {
     ...
     * @return {?}
     */
    function (key) { return decodeURIComponent(key); };
    /**
     * @param {?} value
     * @return {?}
     */
    ...
    function HttpParams(options) {
        ...
        if (!!options.fromString) {
            ...
            Object.keys(options.fromObject).forEach(function (key) {
                /** @type {?} */
                var value = (/** @type {?} */ (options.fromObject))[key]; /** @type {?} */
...
var HttpClient = /** @class */ (function () {
    ...
    function (first, url, options) {
        ...
        /** @type {?} */
        var res$ = /** @type {?} */ (events$.pipe(filter(function (event) { return event instanceof HttpResponse; })));
...
export { HttpBackend, HttpHandler, HttpClient, HttpHeaders, HTTP_INTERCEPTORS, JsonpClientBackend, JsonpInterceptor, HttpClientJsonpModule, HttpClientModule, HttpClientXsrfModule, HttpInterceptingHandler as ɵHttpInterceptingHandler, HttpParams, HttpUrlEncodingCodec, HttpRequest, HttpErrorResponse, HttpEventType, HttpHeaderResponse, HttpResponse, HttpResponseBase, HttpXhrBackend, XhrFactory, HttpXsrfTokenExtractor, NoopInterceptor as ɵa, JsonpCallbackContext as ɵb, jsonpCallbackContext as ɵc, BrowserXhr as ɵd, HttpXsrfCookieExtractor as ɵg, HttpXsrfInterceptor as ɵh, XSRF_COOKIE_NAME as ɵe, XSRF_HEADER_NAME as ɵf };
